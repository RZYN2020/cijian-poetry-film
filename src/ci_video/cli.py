...
def main():
    ...
    for cmd in ["research", "script", "storyboard", "assets", "validate", "tts", "render", "init", "demo", "replay"]:
        ...
        if cmd == "tts":
            ...
            s.add_argument("--provider", choices=["edge", "macos"], default="edge")
        if cmd == "render":
    ...
    try:
        ...
        if args.command == "init":
            ...
            asyncio.run(synthesize(root, fit=args.fit, provider=args.provider))
